...
enum MCEvent: Codable {
  case sentImage(data: Data), sendVideo(data: Data), sendingImage, imageReceived, sendingVideo, videoReceived, imageCanceled
}

private extension String {
  static let serviceType = "surprise-me-app"
}
